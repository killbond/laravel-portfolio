...
class ProjectTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $table = $this->table;
        $data = [
            ['Eternal Wars PVP', 'uploads/1459160619.png', 'Site, shop for private MMORG Rising Force Online server', 'PHP, CodeIgniter, MSSQL', 'Design, Layouts, Development, Maintenance'],
            ['Yana Venevskaya', 'uploads/1459161083.png', 'Internet shop for clothes brand Yana Venevskaya', 'PHP, Expression Engine 2, MySQL, jQuery', 'Layouts, Development'],
            ...
            ['Fabrikant', 'uploads/1459162729.png', 'Site electronic marketplace', 'PHP, Zend 1, Zend 2, jQuery, MySQL, Sphinx', 'Bugfixing, Maintenance'],
            ['Avtosushi', 'uploads/1459163110.png', 'Internet shop foods', 'PHP, Yii 1, Yii 2, jQuery, Node.js, Sockets, PostgreSQL, MySQL', 'Maintenance, Services integration, Business process automatization'],
